...
<div class="relationship-widget">
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            <h4>User Relationships <?= \conerd\humhub\modules\relationships\widgets\RelationshipButton::widget(['user' => $user, 'url' => $url]) ?> </h4>
        ...
        <div class="panel-body">
            <?php
                ...
                foreach ($relationships as $relationship)
                {
                    ...
                    if ($isProfileOwner)
                    {
                        $userUrl = "/u/" . $relationship->user->username;
                        $url = Url::to(['/relationships/relationship/remove-relationship', 'id' => $relationship->id, 'url' => $userUrl]);
                        echo "<td>" . Html::a('<span class="glyphicon glyphicon-trash"></span>', $url, ['style' => 'word-spacing:10px']) . "</td>";
                    }
